...
class TestSupportingPair(unittest.TestCase):
    ...
    def test_polygon2(self):
        pair1 = find_supporting_pair(point1, polygon2, 0, angles2)
        pair2 = find_supporting_pair(point2, polygon2, 0, angles2)
        self.assertIn(pair1[0][0], ((0, 1), (6, 2)))
        self.assertIn(pair1[1][0], ((0, 1), (6, 2)))
    ...
    def test_exception(self):
        with self.assertRaises(Exception):
            find_supporting_pair((0, 0), ((0, 0),), 0, None)
        with self.assertRaises(Exception):
            find_supporting_pair((0, 0), ((0, 0), (0, 0)), 0, None)
        with self.assertRaises(Exception):
...
class TestSupportingPairSemiplanes(unittest.TestCase):
    ...
    def test_polygon1(self):
        pair1 = find_supporting_pair_semiplanes(point1, polygon1, 0)
        pair2 = find_supporting_pair_semiplanes(point2, polygon1, 0)
        self.assertIn(pair1[0][0], ((0, 1), (6, 2)))
        self.assertIn(pair1[1][0], ((0, 1), (6, 2)))
        self.assertIn(pair2[0][0], ((4, 0), (6, 2)))
        self.assertIn(pair2[1][0], ((4, 0), (6, 2)))
    ...
    def test_polygon2(self):
        ...
        pair2 = find_supporting_pair_semiplanes(point2, polygon2, 0)
        self.assertIn(pair1[0][0], ((0, 1), (6, 2)))
        self.assertIn(pair1[1][0], ((0, 1), (6, 2)))
        self.assertIn(pair2[0][0], ((2, 0), (6, 2)))
        self.assertIn(pair2[1][0], ((2, 0), (6, 2)))
    ...
    def test_exception(self):
        with self.assertRaises(Exception):
            find_supporting_pair_semiplanes((0, 0), ((0, 0),), 0)
        with self.assertRaises(Exception):
